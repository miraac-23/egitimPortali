    ...
    switch (b.type) {
      ...
      case "qa":
        return `<div class="qa-wrap">
          <div class="qa-head"><span class="qa-badge">S–C</span> Soru &amp; Cevap</div>
          ${b.items.map(it => `<div class="qa-item">
            <div class="qa-q"><span class="qa-mark q">S</span><span>${inl(it.q)}</span></div>
            <div class="qa-a"><span class="qa-mark a">C</span><span>${inl(it.a)}</span></div>
          </div>`).join("")}
        </div>`;
      case "stats":
