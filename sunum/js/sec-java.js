...
PRESENTATION.sections.push({
  ...
  topics: ["Çoklu İş Parçacığı (4 slayt)", "CompletableFuture (Async)", "Virtual Threads (3 slayt)", "Reflection & Annotations", "Design Patterns", "JDK/JRE/JVM", "JVM Mimarisi", "GC & JIT"],
  slides: [
    /* ---------------- ÇOKLU İŞ PARÇACIĞI ---------------- */
    {
